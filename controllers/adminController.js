...
export const postAddSemester = asyncHandler(async (req, res) => {
...
export const getAddSlot = asyncHandler(async (req, res) => {
    const semester = await semesterModel.getSemesterById(req.params.id);
    res.render('admin/addSlot', { semester, error: null });
});

export const postAddSlot = asyncHandler(async (req, res) => {
...
export const getEditUser = asyncHandler(async (req, res) => {
    const editUser = await userModel.getUserById(req.params.id);
    res.render('admin/editUser', { editUser, error: null });
});

export const postEditUser = asyncHandler(async (req, res) => {
    const { role } = req.body;
